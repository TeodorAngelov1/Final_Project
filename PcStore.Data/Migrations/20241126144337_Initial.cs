        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Brand = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", maxLength: 10000, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LaptopsClients", x => new { x.LaptopId, x.ClientId });
                    table.ForeignKey(
                        name: "FK_LaptopsClients_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LaptopsClients_Laptops_LaptopId",
                        column: x => x.LaptopId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartsClients", x => new { x.PartId, x.ClientId });
                    table.ForeignKey(
                        name: "FK_PartsClients_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PartsClients_Parts_PartId",
                        column: x => x.PartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LaptopsClients_ClientId",
                table: "LaptopsClients",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_PartsClients_ClientId",
                table: "PartsClients",
                column: "ClientId");
        }
